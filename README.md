...
- Abrir PowerShell en `c:\export\analizador-sysmon`.
- Ejecutar `.
...
- Asegúrate de ejecutar el servidor desde `c:\export\analizador-sysmon`.
- Si tu archivo está en `c:\export\sysmon.json`, cópialo a `analizador-sysmon\sample-data\sysmon.json` antes de cargarlo.
